...
bool MyRender::Init()
{
	...
	if (!m_shader->CreateShader(L"multitexture.vs", L"multitexture.ps")) return false;
	if (!m_shader->AddTexture(L"text1.png") || !m_shader->AddTexture(L"text2.png")) return false;
